...
const App: React.FC = () => {
  ...
  return (
    <div className="bg-slate-950 text-slate-200 min-h-screen font-sans selection:bg-gold-500/30 selection:text-white">
      <Navbar />
      ...
      <main>
        ...
        <section className="py-24 relative overflow-hidden">
          <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
            ...
            >
              <span className="text-gold-500 font-serif italic text-xl mb-4 block">Our Philosophy</span>
              <h2 className="text-3xl md:text-5xl font-light leading-relaxed text-white">
                "We believe that true wealth is generated at the intersection of <span className="text-gold-400 font-semibold">tangible assets</span> and <span className="text-gold-400 font-semibold">visionary capital</span>."
              </h2>
              <div className="h-1 w-24 bg-gold-600 mx-auto mt-12"></div>
            </motion.div>
          </div>
        </section>
        ...
        <section id="sectors" className="py-24 bg-slate-950 px-4 sm:px-6 lg:px-8">
           <div className="max-w-7xl mx-auto">
             <div className="flex justify-between items-end mb-12">
               ...
               <button className="hidden md:block text-gold-500 hover:text-white transition-colors border-b border-gold-500 pb-1">
                 View Full Portfolio
               </button>
             </div>
        ...
        <section id="contact" className="py-32 bg-gold-600 relative overflow-hidden">
            ...
            <div className="max-w-5xl mx-auto px-4 text-center relative z-10">
                <motion.h2 
                  ...
                  className="text-4xl md:text-6xl font-serif font-bold text-slate-950 mb-8"
                >
                  Partner with Magnolia
                </motion.h2>
                <p className="text-slate-900/80 text-xl max-w-2xl mx-auto mb-10 font-medium">
                ...
                <motion.button 
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="bg-slate-950 text-white px-8 py-4 text-lg rounded-full font-bold shadow-2xl hover:shadow-xl transition-all"
                >
